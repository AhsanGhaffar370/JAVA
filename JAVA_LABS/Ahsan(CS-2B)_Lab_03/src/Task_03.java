...
public class Task_03 
{
	...
	for(int i=0;i<row;i++)
	{
        ...
        {  
            ...
            */
            DisplayMatrix(MatrixMultiply(matrix1,matrix2,row,column),row,column);
        ...
        */
        DisplayMatrix(MatrixSum(matrix1,matrix2,row,column),row,column);
    ...
    */
    ...
    public static int[][] MatrixMultiply(int matrix1[][],int matrix2[][],int row,int column)
    {   
        int sum=0;
