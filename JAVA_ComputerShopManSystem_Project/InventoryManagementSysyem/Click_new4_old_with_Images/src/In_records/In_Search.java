...
public class In_Search extends javax.swing.JFrame {
    ...
    private void ProdCode_Ser_Action(){
        try{
            ...
            if(t_serPC.getText().equals("")){
                ...
                ser.set_in((JTextField)t_UpDate.getDateEditor().getUiComponent(),t_code, t_prod, t_stock, t_purUP, t_purUP1, t_serPC.getText());
            }
    ...
    private void tab_recAction(){
        ...
        try{
            ...
            t_purUP1.setText(model.getValueAt(row , 5).toString());
    ...
    private void initComponents() {
        ...
        t_purUP1 = new javax.swing.JTextField();
        ...
        jLayeredPane1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 140, 30));
        ...
        t_purUP1.setEditable(false);
        t_purUP1.setBackground(new java.awt.Color(224, 243, 251));
        t_purUP1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        t_purUP1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_purUP1ActionPerformed(evt);
            }
        });
        t_purUP1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                t_purUP1KeyTyped(evt);
            }
        });
        jLayeredPane1.add(t_purUP1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 190, 30));
        ...
        jLayeredPane3.add(b_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 110, 40));
        ...
        jLayeredPane4.setBounds(820, 50, 400, 210);
        ...
        jLabel1.setBounds(910, 50, 270, 220);
    ...
    private void b_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_deleteActionPerformed
            ...
            if( t_UpDate.getDateFormatString().equals("") || t_code.getText().equals("") ||
                t_prod.getText().equals("") || t_purUP.getText().equals("")  || t_purUP1.getText().equals("")
    ...
    private void t_purUP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_purUP1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_t_purUP1ActionPerformed

    private void t_purUP1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_purUP1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_t_purUP1KeyTyped
    ...
    private javax.swing.JTextField t_purUP1;
